                  ...
                  <div className="checkbox-grid">
                    ...
                    <label
                      ...
                      onClick={() =>
                        handleFiltersChange(
                          'enableRatingPosters',
                          !localCatalog?.filters?.enableRatingPosters
                        )
                      }
                      style={{ cursor: 'pointer' }}
                    >
                      <div
                        className={`checkbox ${localCatalog?.filters?.enableRatingPosters ? 'checked' : ''}`}
                      >
                        {localCatalog?.filters?.enableRatingPosters && <Check size={14} />}
                      </div>
                      <LabelWithTooltip
